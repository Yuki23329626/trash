...
# installed.
TCL_PREFIX='/home/gary/usr/foo'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/gary/usr/foo'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/gary/Desktop/src/insight-6.8/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/gary/usr/foo/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/gary/usr/foo/include'
...
# compiled.
TCL_SRC_DIR='/home/gary/Desktop/src/insight-6.8/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/gary/usr/foo/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/gary/Desktop/src/insight-6.8/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/gary/usr/foo/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/gary/Desktop/src/insight-6.8/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/gary/usr/foo/lib/libtclstub8.4${TCL_DBGX}.a'
