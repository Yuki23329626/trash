...
public interface CactusListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CactusParser#bool_expressions}.
	 * @param ctx the parse tree
	 */
	void enterBool_expressions(CactusParser.Bool_expressionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link CactusParser#bool_expressions}.
	 * @param ctx the parse tree
	 */
	void exitBool_expressions(CactusParser.Bool_expressionsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CactusParser#bool_terms}.
	 * @param ctx the parse tree
	 */
	void enterBool_terms(CactusParser.Bool_termsContext ctx);
	/**
	 * Exit a parse tree produced by {@link CactusParser#bool_terms}.
	 * @param ctx the parse tree
	 */
	void exitBool_terms(CactusParser.Bool_termsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CactusParser#arith_expressions}.
	 * @param ctx the parse tree
	 */
	void enterArith_expressions(CactusParser.Arith_expressionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link CactusParser#arith_expressions}.
	 * @param ctx the parse tree
	 */
	void exitArith_expressions(CactusParser.Arith_expressionsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CactusParser#arith_terms}.
	 * @param ctx the parse tree
	 */
	void enterArith_terms(CactusParser.Arith_termsContext ctx);
	/**
	 * Exit a parse tree produced by {@link CactusParser#arith_terms}.
	 * @param ctx the parse tree
	 */
	void exitArith_terms(CactusParser.Arith_termsContext ctx);
	/**
